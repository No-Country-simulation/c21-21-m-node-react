        ...
        <section className="bg-customGray bg-opacity-60 p-12 rounded-lg" id="privacy-policy">
            <div className="container mx-auto px-4">
                ...
                <div className="bg-customWhite p-8 rounded-lg">
                    ...
                    <p className="mb-4 text-customBlack">Recopilamos diferentes tipos de información cuando accedes y usas nuestra plataforma, incluyendo:</p>
                    ...
                    <p className="mb-4 text-customBlack">Para ejercer cualquiera de estos derechos, puedes contactarnos a través de contacto@boostup.com.</p>
